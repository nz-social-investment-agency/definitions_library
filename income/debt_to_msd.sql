...
Intended purpose:
1. Identifying debtors.
2. Calculating number of debts and total value of debts.
3. Calculating change in debts - due to borrowing or repayment.

Inputs & Dependencies:
- "classifying MSD debt using T3 data.sql" --> [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt]
Outputs:
- [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_msd_non_transactions]
- [IDI_UserCode].[DL-MAA20XX-YY].[d2gP2_msd_labels_balance]
- [IDI_UserCode].[DL-MAA20XX-YY].[d2gP2_msd_labels_transactions_part1]
- [IDI_UserCode].[DL-MAA20XX-YY].[d2gP2_msd_labels_transactions_part2]
- [IDI_UserCode].[DL-MAA20XX-YY].[d2gP2_msd_labels_repayments_part1]
- [IDI_UserCode].[DL-MAA20XX-YY].[d2gP2_msd_labels_repayments_part2]
- [IDI_UserCode].[DL-MAA20XX-YY].[d2gP2_msd_labels_persist]
...
**************************************************************************************************/
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_signs_handled];
GO
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_signs_handled]
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt]

/**************************************************************************************************
Split repayments and write-offs into overpayment and recoverable assistance
**************************************************************************************************/
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_classified_msd_repayment];
GO
...
recoverable_assistance_range AS (
	...
	FROM [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_signs_handled]
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_classified_msd_repayment]
FROM split
GROUP BY snz_uid, debt_as_at_date

/* Index by snz_uid (improve efficiency) */
CREATE NONCLUSTERED INDEX snz_uid_index ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_classified_msd_repayment] (snz_uid); 
GO
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt_and_repayment];
GO
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt_and_repayment]
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_signs_handled] AS c
LEFT JOIN [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_classified_msd_repayment] AS r
ON c.snz_uid = r.snz_uid
AND c.debt_as_at_date = r.debt_as_at_date

/* Index by snz_uid (improve efficiency) */
CREATE NONCLUSTERED INDEX snz_uid_index ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt_and_repayment] (snz_uid); 
GO
/*********** compress tables ***********/
ALTER TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt_and_repayment] REBUILD PARTITION = ALL WITH (DATA_COMPRESSION = PAGE)
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_msd_debt_prep];
GO
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_msd_debt_prep]
FROM(
	SELECT *
	...
	FROM [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt_and_repayment]
)b

/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_msd_debt_prep] (snz_uid);
GO

/**************************************************************************************************
fill in records where balance is non-zero but transactions are zero
**************************************************************************************************/
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_msd_non_transactions];
GO
...
debt_source AS (
	...
	FROM [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_tmp_msd_debt_prep]
),
...
SELECT *
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_msd_non_transactions]
FROM (
	/* original records */
	SELECT snz_uid
		,snz_msd_uid
...
/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_msd_non_transactions] ([snz_uid]);
GO
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[d2gP2_msd_labels_balance];
GO

CREATE VIEW [DL-MAA20XX-YY].[d2gP2_msd_labels_balance] AS
SELECT snz_uid
	,debt_as_at_date
	,balance
	,balance_overpayment
...
FROM[IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_msd_non_transactions]
GO
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[d2gP2_msd_labels_transactions];
GO

CREATE VIEW [DL-MAA20XX-YY].[d2gP2_msd_labels_transactions] AS
SELECT snz_uid
	,snz_msd_uid
	,debt_as_at_date
	,amount_incurred
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[msd_labels_pre2019];
GO                   

CREATE VIEW [DL-MAA20XX-YY].[msd_labels_pre2019] AS
SELECT snz_uid 
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[d2gP2_msd_labels_repayments];
GO

CREATE VIEW [DL-MAA20XX-YY].[d2gP2_msd_labels_repayments] AS
SELECT snz_uid
    ,snz_msd_uid
	,debt_as_at_date
	,amount_repaid
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[msd_labels_persist];
GO

CREATE VIEW [DL-MAA20XX-YY].[d2gP2_msd_labels_persist] AS
SELECT snz_uid
	,snz_msd_uid
	,debt_as_at_date
	,balance
