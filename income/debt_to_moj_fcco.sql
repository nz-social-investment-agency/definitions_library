...
Outputs:
- [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_fcco_transactions_ready]
...
**************************************************************************************************/
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_moj_debt_fcco_monthly_balances]','U') IS NOT NULL
DROP TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_moj_debt_fcco_monthly_balances];
GO
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_moj_debt_fcco_monthly_balances]
FROM debt_source
WHERE month_date <= '2020-12-31'
GO
/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_moj_debt_fcco_monthly_balances] ([fcco_file_nbr]);
GO

/**************************************************************************************************
fill in records where balance is non-zero but transactions are zero
**************************************************************************************************/
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_fcco_non_transactions]','U') IS NOT NULL
DROP TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_fcco_non_transactions];
GO
...
debt_source AS(
	...
	FROM [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_moj_debt_fcco_monthly_balances]
),
joined AS (
	SELECT *
	FROM debt_source
...
SELECT * 
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_fcco_non_transactions]
FROM (
	/* original records */
...
/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_fcco_non_transactions] ([fcco_file_nbr]);
GO
...
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_moj_fcco_debt_id]','U') IS NOT NULL
DROP TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_moj_fcco_debt_id];
GO
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_moj_fcco_debt_id]
...
LEFT JOIN [IDI_Clean_YYYYMM].[security].[concordance] AS sc
...
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[[d2gP2_fcco_transactions_ready]]','U') IS NOT NULL
DROP TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_fcco_transactions_ready];
GO

SELECT b.snz_uid
       ,a.*
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_fcco_transactions_ready]
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_fcco_non_transactions] a
LEFT JOIN [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_moj_fcco_debt_id] b
ON a.fcco_file_nbr = b.fcco_file_nbr

/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_fcco_transactions_ready] (snz_uid);
GO
