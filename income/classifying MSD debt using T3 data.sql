...
Intended purpose:
1. Intermediate table for detailed MSD debt to be extracted from.
2. Identifying debtors, type of debt, and changes in debt.
...
**********************************************************************/
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[tmp_msd_debt_principle]','U') IS NOT NULL DROP TABLE [IDI_Sandpit].[DL-MAA2020-01].[tmp_msd_debt_principle];
GO
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_msd_debt_principle]
FROM [IDI_Adhoc].[clean_read_DEBT].[msd_debt_30sep] AS a
INNER JOIN [IDI_Clean_YYYYMM].[security].[concordance] AS b -- adding snz_uid 
...
**********************************************************************/
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[tmp_recoverable_t3]','U') IS NOT NULL DROP TABLE [IDI_Sandpit].[DL-MAA2020-01].[tmp_recoverable_t3];
GO
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_recoverable_t3]
FROM prep_t3
GROUP BY [snz_uid], [snz_msd_uid], [decision_month]

/* Index by snz_uid (improve efficiency) */
CREATE CLUSTERED INDEX snz_uid_index ON [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_recoverable_t3] (snz_uid); 

/**********************************************************************
attach T3 to MSD debt 
**********************************************************************/
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[tmp_augmented_msd_debt]','U') IS NOT NULL DROP TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_augmented_msd_debt];
GO
...
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_msd_debt_principle] AS pr
LEFT JOIN [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_recoverable_t3] AS t3
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_augmented_msd_debt]
...
**********************************************************************/
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt]','U') IS NOT NULL DROP TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt];
GO
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt]
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_msd_debt_principle] AS a
LEFT JOIN [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_augmented_msd_debt] AS b
...
/* Index by snz_uid (improve efficiency) */
CREATE CLUSTERED INDEX snz_uid_index ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt] (snz_uid); 
/* Compact table to save space */
ALTER TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_classified_msd_debt] REBUILD PARTITION = ALL WITH (DATA_COMPRESSION = PAGE)

/**********************************************************************
remove temporary tables
**********************************************************************/
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[tmp_msd_debt_principle]','U') IS NOT NULL DROP TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_msd_debt_principle];
GO
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[tmp_recoverable_t3]','U') IS NOT NULL DROP TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_recoverable_t3];
GO
IF OBJECT_ID('[IDI_Sandpit].[DL-MAA20XX-YY].[tmp_augmented_msd_debt]','U') IS NOT NULL DROP TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_augmented_msd_debt];
GO