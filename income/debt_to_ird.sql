...
Outputs:
- [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_ird_transactions_ready]
- [IDI_UserCode].[DL-MAA20XX-YY].[ird_labels_balance]
- [IDI_UserCode].[DL-MAA20XX-YY].[ird_labels_transactions]
- [IDI_UserCode].[DL-MAA20XX-YY].[ird_labels_repayments]
- [IDI_UserCode].[DL-MAA20XX-YY].[ird_labels_persist]
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_ir_debt_transactions];
GO

SELECT *
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_ir_debt_transactions]
FROM (
...
/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_ir_debt_transactions] ([snz_ird_uid], [snz_case_number], [tax_type_group]);
GO
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[ir_debt_transactions_corrected];
GO
...
WITH standardised AS (
	...
	FROM [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_ir_debt_transactions]
)
SELECT *
...
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[ir_debt_transactions_corrected]
FROM standardised

/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[ir_debt_transactions_corrected] ([snz_ird_uid],[tax_type_group]);
GO
/**************************************************************************************************
fill in records where balance is non-zero but transactions are zero
**************************************************************************************************/

DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_ird_non_transactions];
GO
...
debt_source AS (
	...
	FROM [IDI_Sandpit].[DL-MAA20XX-YY].[ir_debt_transactions_corrected]
),
...
SELECT *
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_ird_non_transactions]
FROM (
	/* original records */
	SELECT snz_ird_uid
		,snz_case_number
...
/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_ird_non_transactions] ([snz_ird_uid]);
GO
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_ird_transactions_ready];
GO

SELECT b.snz_uid
	,a.*
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_ird_transactions_ready]
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_ird_non_transactions] AS a
LEFT JOIN [IDI_Clean_YYYYMM].[security].[concordance] AS b
ON a.snz_ird_uid = b.snz_ird_uid

/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_ird_transactions_ready] (snz_uid);
GO
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[ird_labels_balance];
GO

CREATE VIEW [DL-MAA20XX-YY].[ird_labels_balance] AS
SELECT snz_uid
	,month_end
	,tax_type_label
	,running_balance_tax_type_num
...
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[d2gP2_ird_transactions_ready]
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[ird_labels_transactions];
GO

CREATE VIEW [DL-MAA20XX-YY].[ird_labels_transactions] AS
SELECT snz_uid
	,month_end
	,tax_type_label
	,pre_2019
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[ird_labels_repayments];
GO

CREATE VIEW [DL-MAA20XX-YY].[ird_labels_repayments] AS
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[ird_labels_persist];
GO

CREATE VIEW [DL-MAA20XX-YY].[ird_labels_persist] AS
SELECT snz_uid
	,snz_case_number
	,month_end
	,tax_type_label
