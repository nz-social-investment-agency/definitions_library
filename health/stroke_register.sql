...
Outputs:
- [IDI_Sandpit].[DL-MAA20XX-YY].[defn_stroke]
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[defn_stroke]
GO

CREATE TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[defn_stroke] (
	snz_uid	INT
	, event_date DATE
	, source VARCHAR(255)
);
...
/** PUBLIC HOSPITALS **/
INSERT INTO [IDI_Sandpit].[DL-MAA20XX-YY].[defn_stroke] (snz_uid, event_date, source)
SELECT snz_uid,
