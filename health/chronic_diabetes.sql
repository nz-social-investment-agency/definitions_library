...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_pfhd_chronic_diags];
GO
...
SELECT [moh_dia_event_id_nbr] AS [event_id]
	  ...
	  ,'pub_diab' AS [source]
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_pfhd_chronic_diags]
...
/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_pfhd_chronic_diags] ([event_id]);
GO

/* Clear before creation */
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_vfhd_chronic_diags];
GO
...
SELECT [moh_pri_diag_event_id_nbr] AS [event_id]
	  ...
	  ,'priv_diab' AS [source]
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_vfhd_chronic_diags]
...
/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_vfhd_chronic_diags] ([event_id]);
GO

/* Clear before creation */
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_pharm_chronic_diags];
GO
...
SELECT [snz_uid]
      ...
      --,[FORMULATION_ID]
      --,[FORMULATION_NAME]
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_pharm_chronic_diags]
FROM [IDI_Clean_YYYYMM].[moh_clean].[pharmaceutical] a
...
/* Clear before creation */
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_nnpac_chronic_diags];
GO

/************************************ National Non-Admitted Patient Collection ************************************/
SELECT [snz_uid]
	  ,MIN([moh_nnp_service_date]) AS [moh_nnp_service_date]
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_nnpac_chronic_diags]
...
/* Clear before creation */
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[defn_chronic_diabetes];
GO

/************************************ combined final table ************************************/

SELECT *
INTO [IDI_Sandpit].[DL-MAA20XX-YY].[defn_chronic_diabetes]
FROM (
/* public */
SELECT [snz_uid]
	  --,[event_id]
...
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_pfhd_chronic_diags] a
INNER JOIN [IDI_Clean_YYYYMM].[moh_clean].[pub_fund_hosp_discharges_event] b
...
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_vfhd_chronic_diags] a
INNER JOIN [IDI_Clean_YYYYMM].[moh_clean].[priv_fund_hosp_discharges_event] b
...
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_pharm_chronic_diags]
...
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[defn_tmp_nnpac_chronic_diags]

) k

/* Add index */
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[defn_chronic_diabetes] ([snz_uid]);
GO
/* Compress final table to save space */
ALTER TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[defn_chronic_diabetes] REBUILD PARTITION = ALL WITH (DATA_COMPRESSION = PAGE);
GO
