...
Outputs:
- [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_serious_Mental_health_list]
- [IDI_UserCode].[DL-MAA20XX-YY].[vacc_recent_serious_Mental_health]
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_serious_Mental_health_list]
GO

CREATE TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_serious_Mental_health_list] (
	snz_uid INT,
	code VARCHAR(12),
	descript VARCHAR(25),
...
INSERT INTO [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_serious_Mental_health_list] (snz_uid, code, descript, record_source, event_date)
SELECT b.snz_uid
...
FROM [IDI_Clean_YYYYMM].[moh_clean].priv_fund_hosp_discharges_diag as a
INNER JOIN [IDI_Clean_YYYYMM].[moh_clean].priv_fund_hosp_discharges_event as b
...
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_serious_Mental_health_list] (snz_uid);
GO
ALTER TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_serious_Mental_health_list] REBUILD PARTITION = ALL WITH (DATA_COMPRESSION = PAGE)
GO
...
DROP VIEW IF EXISTS [DL-MAA20XX-YY].[vacc_recent_serious_Mental_health]
GO

CREATE VIEW [DL-MAA20XX-YY].[vacc_recent_serious_Mental_health] AS 
SELECT DISTINCT snz_uid
FROM [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_serious_Mental_health_list]
