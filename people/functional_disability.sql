...
SELECT [snz_uid]
	...
	,CASE
		...
		ELSE 0 END AS dv_communication
FROM [IDI_Clean_20211020].[gss_clean].[gss_person]
GO
...
INNER JOIN [IDI_Clean_20211020].[security].[concordance] as c
...
single_person_source_date_record AS (
	...
	FROM [IDI_Sandpit].[DL-MAA20XX-YY].[tmp_functional_disability_list]
