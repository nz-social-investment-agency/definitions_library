...
Outputs:
- [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_education_enrollments]
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_education_enrollments]
GO

CREATE TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_education_enrollments] (
	snz_uid INT,
	snz_moe_uid INT,
	enroll_type INT,
	provider_code INT,
...
FROM [IDI_Clean_YYYYMM].[moe_clean].[student_enrol] 
...
FROM [IDI_Clean_YYYYMM].[moe_clean].[course]
...
CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_education_enrollments] (snz_uid);
GO
ALTER TABLE [IDI_Sandpit].[DL-MAA20XX-YY].[vacc_education_enrollments] REBUILD PARTITION = ALL WITH (DATA_COMPRESSION = PAGE)
GO
